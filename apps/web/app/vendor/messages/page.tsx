        ...
        <div className="w-full md:w-[400px] border-r flex flex-col bg-muted/5">
           <div className="p-8 space-y-6">
              <div className="flex items-center justify-between">
                 <h1 className="text-3xl font-black italic tracking-tighter uppercase">Vendor Inbox</h1>
              ...
              {selectedThread ? (
                ...
                >
                   ...
                   <div className="p-8 bg-background flex items-center gap-4">
                      <div className="relative flex-1 flex items-center gap-4 bg-muted/20 p-2 rounded-[2.5rem] border focus-within:border-primary/30 transition-all">
                ...
                <div className="flex-1 flex flex-col items-center justify-center text-center p-12 space-y-6">
                   ...
                   <div className="space-y-2">
                      <h2 className="text-2xl font-black italic uppercase tracking-tighter">Vendor Inbox</h2>
                      <p className="text-sm text-muted-foreground font-medium uppercase tracking-widest max-w-xs">Select a conversation to reply to a customer inquiry.</p>
                   </div>
                </div>
              )}
           </AnimatePresence>
